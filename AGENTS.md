...
| [`docs/decisions/lot-v5-22.md`](docs/decisions/lot-v5-22.md) | **A308** — le gestionnaire de catégories passe en LISTE (rangées 44 px, « Ajouter » en tête, palette ouverte pour UNE catégorie à la fois), plus de couleurs par un curseur de teinte sur l'anneau OKLCH L 0,48 · C 0,08 (chroma maximale dans le gamut ; les deux contrastes de la régression #3 tiennent par construction, garde-fou de proximité 4,0 ΔE) ; le rail de session passe à 280 px entre 780 et 999 (à 820 px, 320 laissait 444 px à l'action) |
