...
| [`docs/decisions/lot-v5-23.md`](docs/decisions/lot-v5-23.md) | **A317-A321** — le partage SANS QUESTION (demande de l'auteur : « le maître mot c'est seamless »). **A317 (v5.23.0)** : un seul état visible, « ● Partagé » quel que soit le canal — le transport se lit dans la feuille et aux transitions |
