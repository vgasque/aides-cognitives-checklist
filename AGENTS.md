...
- **K1 + K3 + MK5-b — ON ÉDITE DANS LA GRAMMAIRE DE LECTURE (v4.64.0, maquettes MK de l'audit)** :
  ...
  **K6 — LE DISCRIMINANT A SON CHAMP (v4.70.0)** : « adulte », « pédiatrique », « femme
  ...
  répertoire, tuile, et — depuis A139 — **le SUR-TITRE de l'en-tête**, jamais dans la chaîne qui se
  coupe. ⚠ Cette dernière phrase a été FAUSSE de la v4.70.0 à la v5.10.1 : la pilule était le
  dernier enfant de `#brandTitle`, qui s'ellipse, donc la première chose amputée — le défaut même
  que ce champ existe pour supprimer, avec une doctrine qui affirmait la protection (cf. A139).
