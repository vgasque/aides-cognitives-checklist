...
| A308-A309 | `lot-v5-22.md` | Le gestionnaire de catégories en liste (une palette à la fois, « Ajouter » en tête, curseur de teinte OKLCH lisible par construction) ; le rail de session à 280 px entre 780 et 999, et ses deux ajouts sur une rangée. |
