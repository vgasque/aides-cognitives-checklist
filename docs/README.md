...
| A333-A334 | `lot-v5-27.md` | « Reprendre » après une complication ramène le passage interrompu (même visite, coches gardées) avec la carte ⚡ juste avant — renverse A126 ; replis et « entrée suivante du fil » suivent ; la barre « ↩ Bloc… » se resynchronise à tout changement de vue (elle survivait à « Terminer » sur l'accueil). |
