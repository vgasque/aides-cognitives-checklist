...
| A336-A338 | `lot-v5-28.md` | « Terminer la session… » au pied du volet et du rail (la fenêtre reste la seule porte) ; menu ⋯ refait — tuiles, intertitres, pli « L'aide », sans doublon du dock en session ; méta des rangées d'accueil : identité à gauche, un état en mots à droite |
