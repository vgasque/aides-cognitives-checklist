...
| A327-A328 | `lot-v5-24.md` | La feuille de partage dit quoi faire : canal choisi par l'app (par l'écran d'office sans adresse locale), étapes numérotées en miroir hôte/invité, bandeau = étape ①, l'hôte reçoit aussi, porte de secours « Mode : automatique › ». |
