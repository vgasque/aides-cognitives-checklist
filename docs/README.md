...
| A332 | `lot-v5-26.md` | Ce que la panne fait aux gestes : arrêt de minuteur daté chez l'autre, file de l'hôte jamais refusée pour péremption, retour de l'hôte sans invité par son billet, reprise de l'invité repeinte, bridage visible de l'invité périmé ; carte des situations réseau mesurées. |
