...
| A317-A325 | `lot-v5-23.md` | Le partage sans question : un seul état « ● Partagé », détection de panne en 5 s et secours annoncé, retour automatique au cloud avec hystérésis, réveil qui ré-apparie seul, journal du lien. |
