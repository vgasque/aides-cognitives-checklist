...
| **T7** | Éditeur v4. **◐ PARTIELLEMENT LIVRÉ** : « ×2 » (`dual`, AC 120-71B §5.2.2.5) de bout en bout — bascule dans l'éditeur, pilule en lecture, persistance, survie à l'export. **RESTE** : `★ mémoire` et `phase`, qui ne sont pas des champs à écrire mais des changements de ce qu'une SURFACE affiche (composition du chapeau ; decluttering). | T6 rendu ✅ | moyen |
