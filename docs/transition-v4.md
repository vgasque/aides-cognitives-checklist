...
| **T8** | **Axe de densité** (3 crans) + page SFAR + **onglet Schéma**. Suppression de guidé/statique/lecteur/se repérer comme surfaces. **`buildFlowSVG` est REPRIS TEL QUEL** — on n'y ajoute que la zone « ⚡ À tout moment » (cf. § 3.1). | T5, T6 | **élevé** |
