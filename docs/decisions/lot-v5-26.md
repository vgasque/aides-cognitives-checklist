...
verrouillé, autre application ou réseau : la cause n'est pas connue) » — registre neutre, v5.26.5,
la première formulation ayant été jugée familière par l'auteur, puis ce qui est sûr — rien n'est perdu, ce
